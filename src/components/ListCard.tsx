...
export default function ListCard({
  ...
  return (
    <Link href={link || "#"} {...linkProps}>
      <div className="min-w-[340px] min-h-[74px] px-4 py-2 flex items-center justify-start gap-x-4 bg-white rounded-md shadow-md text-sm overflow-hidden hover:bg-slate-50 hover:shadow-sm active:bg-gray-200 active:shadow-none">
        {img && (
          <Image
